...
//       <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold border border-textGreen rounded-lg p-6 bg-greenOverlay">
//         🚧🛠️ Website Under Reconstruction 👷🏗️
//       </h1>
//     </div>
//   );
// };
