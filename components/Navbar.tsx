          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center text-base gap-7">
                ...
                <div className="flex gap-4">
                  <motion.a
                    ...
                    href="https://www.linkedin.com/in/danieloriazowan"
                    target="_blank"
                  >
                    <span className="w-10 h-10 text-x1 bg-hoverColor rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                      <TbBrandGithub />
                    </span>
                  </motion.a>
                  <motion.a
              ...
              <motion.a
                ...
                href="mailto:doriazowan@gmail.com"
              >
                <p>doriazowan@gmail.com</p>
              </motion.a>
            </motion.div>
          </div>
        )}
