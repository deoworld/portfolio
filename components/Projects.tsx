...
import { cyberImg } from "@/public/assets";
import { doShop } from "@/public/assets";
            ...
            <div className="w-full xl:w-1/2 flex flex-col gap-6 lgl:justify-between items-end text-right xl:-ml-16 z-10">
              ...
              <div className="text-2xl flex gap-4">
                <a
                  ...
                  href="https://github.com/deoworld"
                  target="_blank"
                >
                  <TbBrandGithub />
                </a>
        ...
        <div className="w-full flex flex-col items-center justify-center gap-28 mt-10">
          <div className="flex flex-col xl:flex-row-reverse gap-6">
            ...
            <div className="w-full xl:w-1/2 flex flex-col gap-6 lgl:justify-between items-end text-right z-10">
              ...
              <h3 className="text-2xl font-bold">Cybersecurity Blog</h3>
        ...
        <div className="w-full flex flex-col items-center justify-center gap-28 mt-10">
          <div className="flex flex-col xl:flex-row gap-6">
            ...
            <div className="w-full xl:w-1/2 flex flex-col gap-6 lgl:justify-between items-end text-right xl:-ml-16 z-10">
              ...
              <h3 className="text-2xl font-bold">DO Shop</h3>
              <p className="bg-[#112240] text-sm md:text-base p-2 md:p-6 rounded-md">
                An Amazon clone website for visualizing personalized Amazon
                website. View your products, Add your account with{" "}
                <span className="text-textGreen">0-auth</span> and then make the
